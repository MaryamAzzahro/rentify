    ...
    public function store(Request $r)
{
    ...
    return redirect('/register')->with('status', 'success')->with('msg', 'Proses registrasi berhasil, silahkan kembali ke halaman ' . '<a href="' . route('login') . '"><strong><ins>login</ins></strong></a> !');
}
    ...
    public function authenticate(Request $r)
{
    ...
    return redirect('/login')->with('status', 'NIM atau kata sandi salah !');
}
